...
app.MapApiGroup().MapPingEndpoint().MapCinemasEndpoints().MapTimePreferencesEndpoints().MapSeatMatricesEndpoints().MapHomeEndpoints().MapPerformanceDetailEndpoints().MapTrackedMoviesEndpoints().MapScheduleEndpoints();

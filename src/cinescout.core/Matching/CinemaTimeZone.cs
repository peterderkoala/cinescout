...
/// <summary>
/// CineScout crawls a single, hardcoded German cinema today (see CONTEXT.md's Cinema glossary entry),
/// so a single hardcoded IANA zone id is the deliberate simplification, matching the rest of this
/// codebase's single-cinema posture — not something to generalize until a second, differently-zoned
/// Cinema is actually configured. <see cref="cinescout.model.Performance.StartsAt"/> is persisted via
